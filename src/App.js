...
import selectObjects from "./lib/Logic";
...
function animate() {
  ...
  // Directional Light
  {
    ...
    light_objects.DirectionalLight.members.push(
      DirectionalFactory(0xffffff, 0.3, [-25, 50, 25])
    );
    light_objects.DirectionalLight.members.push(
      DirectionalFactory(0xffffff, 0.3, [25, 50, 25])
    );
    ...
    light_objects.DirectionalLight.members.push(
      DirectionalFactory(0xffffff, 0.3, [-30, 0, 30])
    );
    light_objects.DirectionalLight.members.push(
      DirectionalFactory(0xffffff, 0.3, [30, 0, 30])
    );
  ...
  // PointLight
  {
    ...
    light_objects.PointLight.members.push(
      PointLightFactory(0xffffff, 1, [-25, 50, 25])
    );
    light_objects.PointLight.members.push(
      PointLightFactory(0xffffff, 1, [25, 50, 25])
    );
    ...
    light_objects.PointLight.members.push(
      PointLightFactory(utility.generateRandomColor(), 1, [-30, 0, 30])
    );
    light_objects.PointLight.members.push(
      PointLightFactory(utility.generateRandomColor(), 1, [30, 0, 30])
    );
  ...
  // Spotlights
  {
    ...
    light_objects.Spotlights.members.push(
      SpotLightFactory(
  ...
  function ballFactory(color) {
    ...
    obj.wireframe = new THREE.LineSegments(
      wireframe_geometry,
      wireframe_material
    );
  ...
  //setup object
  const getObjects = new selectObjects();
